...
function plot_changes_monthly_discharge_all_catchments(All_Catchment_Names, Elevation)
    ...
    plot(all_boxplots[1], all_boxplots[2], all_boxplots[3], all_boxplots[4], all_boxplots[5], all_boxplots[6], layout= (3,2), legend = false, size=(2000,1500), left_margin = [5mm 0mm], bottom_margin = 20px, yguidefontsize=20, xtickfont = font(20), ytickfont = font(20), dpi=300)
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/monthly_discharges_all_catchments_different_scales.pdf")
end
...
function plot_changes_monthly_discharge_all_catchments_absolute(All_Catchment_Names, Elevation, Area_Catchments)
    ...
    plot(all_boxplots[1], all_boxplots[2], all_boxplots[3], all_boxplots[4], all_boxplots[5], all_boxplots[6], layout= (3,2), legend = false, size=(2000,1500), left_margin = [5mm 0mm], bottom_margin = 20px, yguidefontsize=20, xtickfont = font(20), ytickfont = font(20), dpi=300)
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/monthly_discharges_all_catchments_absolute_change.pdf")
end
...
function plot_changes_prec_temp_discharge_all_catchments(All_Catchment_Names, Elevation, nr_runs)
    ...
    plot(all_boxplots_temp[1], all_boxplots_temp[2], all_boxplots_temp[3], all_boxplots_temp[4], all_boxplots_temp[5], all_boxplots_temp[6],
        ...
        layout= (3,6), legend = false, size=(2600,1200), left_margin = [5mm 0mm], bottom_margin = 20px, yguidefontsize=20, xtickfont = font(20), ytickfont = font(20), dpi=300)#, minorticks=true, minorgrid=true)
    #savefig("/home/sarah/Master/Thesis/Results/Projektionen/annual_prec_temp_all_catchments_absolute_change_prec_q_rel4.png")
    # plot()
    # plot(all_boxplots_temp[1], all_boxplots_temp[2], all_boxplots_temp[3], all_boxplots_temp[4], all_boxplots_temp[5], all_boxplots_temp[6], layout= (3,2), legend = false, size=(2000,1500), left_margin = [5mm 0mm], bottom_margin = 20px, yguidefontsize=20, xtickfont = font(20), ytickfont = font(20), dpi=300)
    savefig("monthly_temperature_all_catchments_absolute_change4.png")
end
    ...
    for (i,Catchment_Name) in enumerate(All_Catchment_Names)
        ...
        for month in 1:12
            ...
            elseif change == "relative"
                boxplot!([xaxis_45[month]], relative_error(Prec_statistics_future_45[index, index_month], Prec_statistics_past_45[index, index_month]), size=(2000,800), leg=false, color=["blue"], alpha=0.8, outliers=false)
                scatter!(ones(14)*xaxis_45[month], relative_error(Prec_statistics_future_45[index, index_month], Prec_statistics_past_45[index, index_month]), color="black")
                boxplot!([xaxis_85[month]], relative_error(Prec_statistics_future_85[index, index_month], Prec_statistics_past_85[index, index_month]), size=(2000,800), leg=false, color=["red"], left_margin = [5mm 0mm], minorticks = true, gridlinewidth=2, outliers=false, framestyle = :box)
                scatter!(ones(14)*xaxis_85[month], relative_error(Prec_statistics_future_85[index, index_month], Prec_statistics_past_85[index, index_month]), color="black")
            end
        end
        hline!([0], color=["grey"], linestyle = :dash)
        #title!("Relative Change in Discharge RCP 4.5 =blue, RCP 4.5 = red")
...
function plot_timing_changes_AMF_all_Catchments_fraction_4585(All_Catchment_Names, Elevation, nr_runs, errorbounds)
    ...
    for (j,Catchment_Name) in enumerate(All_Catchment_Names)
        ...
        if errorbounds == true
            ...
            scatter!(xaxix_days, mean_per_15_days_future_85, leg=false, size=(1500,800), color=[Farben85[2]], markersize=7, markerstrokecolor=[Farben85[2]], left_margin = [5mm 0mm], bottom_margin = 20px, xrotation = 60, label="Future RCP 4.5")
...
function plot_changes_magnitude_AMF_return_periods(All_Catchment_Names, Elevation, Area_Catchments, type, change)
    ...
    plot(all_boxplots[1], all_boxplots[2], all_boxplots[3], all_boxplots[4], all_boxplots[5], all_boxplots[6], layout= (3,2), legend=true, legendfontsize= 12, size=(2200,1500), left_margin = [5mm 0mm], bottom_margin = 20px, yguidefontsize=20, xguidefontsize=20, xtickfont = font(20), ytickfont = font(20), dpi=300)
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/AMF_magnitude_all_Catchments_all_years_return_period_log_absolute_legend.png")
end
...
function plot_monthly_deficit_all_catchments_absolute(All_Catchment_Names, Elevation, Area_Catchments, nr_runs)
    ...
    plot(all_boxplots[1], all_boxplots[2], all_boxplots[3], all_boxplots[4], all_boxplots[5], all_boxplots[6], layout= (3,2), legend=true, legendfontsize= 12, size=(2200,1500), left_margin = [5mm 0mm], bottom_margin = 20px, yguidefontsize=20, xtickfont = font(20), ytickfont = font(20), dpi=300)#, yguidefontsize=20, xtickfont = font(15), ytickfont = font(15))
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/Drought_Monthly_Deficit_Q90_absolute_no_outliers_legend.png")
end
...
function plot_Q90_Prec_all_catchments(All_Catchment_Names, Elevation, Area_Catchments, nr_runs)
    ...
    for (i,Catchment_Name) in enumerate(All_Catchment_Names)
        ...
        writedlm("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/Q90_4.5.txt",relative_error(Q90_Prec_Future45, Q90_Prec_Past45)*100,',')
        if Catchment_Name == "Pitten"
            Catchment_Name = "Feistritz"
        elseif Catchment_Name == "IllSugadin"
            Catchment_Name = "Silbertal"
...
function plot_magnitude_low_flows(All_Catchment_Names, Elevation, Area_Catchments, nr_runs, change)
    ...
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/low_flows_magnitude_"*change*"_change_timing_Pitztal_snow_redistr.png")
end
...
function plot_timing_changes_low_flows_all_Catchments_fraction_4585(All_Catchment_Names, Elevation, nr_runs, errorbounds)
    ...
    plot(all_boxplots[1], all_boxplots[2], all_boxplots[3], all_boxplots[4], all_boxplots[5], all_boxplots[6], layout= (3,2), legend=false, legendfontsize= 12, size=(2200,1500), left_margin = [5mm 0mm], bottom_margin = 20px, yguidefontsize=20, xtickfont = font(20), ytickfont = font(20), dpi=300)#, yguidefontsize=20, xtickfont = font(15), ytickfont = font(15))
    if errorbounds == true
        savefig("/home/sarah/Master/Thesis/Results/Projektionen/low_flows_timing_all_catchments_4585_with_std_2.png")
    else
...
function budyko_framework_per_decade(All_Catchment_Names, Area_Catchments)
    ...
    for (i,Catchment_Name) in enumerate(All_Catchment_Names)
        ...
        scatter!([aridity_past], [evaporative_past], label=Catchment_Name, color=[Farben[i]], markershape=Marker_Time[1], markersize= 7,  markerstrokewidth= 0)
    ...
    #vline!([0.406])
    #plot(all_plots[1], all_plots[2], all_plots[3], all_plots[4], all_plots[5], all_plots[6], layout= (3,2), legend = true, size=(2000,1500), left_margin = [5mm 0mm], bottom_margin = 20px, yguidefontsize=20, xtickfont = font(20), ytickfont = font(20), dpi=300)
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/budyko_all_catchments_final_with_legend_Pitztal_calibration.png")
end
...
function plot_monthly_snowmelt_all_catchments(All_Catchment_Names, Elevation)
    ...
    for (i,Catchment_Name) in enumerate(All_Catchment_Names)
        ...
        for month in 1:12
            violin!([past[month]], Monthly_Discharge_past[findall(x-> x == month, months_45)] ./ divide[month], color =["grey"])
    ...
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/monthly_snow_storage_all_catchments_correct_violin.png")
end
...
function plot_monthly_snowmelt_all_catchments_std(All_Catchment_Names, Elevation)
    ...
    plot(all_boxplots[1], all_boxplots[2], all_boxplots[3], all_boxplots[4], all_boxplots[5], all_boxplots[6], layout= (3,2), legend = false, size=(2000,1500), left_margin = [5mm 0mm], bottom_margin = 20px, yguidefontsize=20, xtickfont = font(20), ytickfont = font(20), dpi=300)
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/monthly_snow_melt_all_catchments_std_scaled2.png")
end
