...
Precipitation_Sample = Precipitation[:,25]/10
...
Nr_Elevationbands, Prec_Elevation, Temp_Elevation = getelevationdata(100, 1093, 2238, 3527, 0.003, Temp_Sample, Precipitation_Sample)
