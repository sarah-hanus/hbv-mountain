...
Elevation, Prec_Elevation, Temp_Elevation, Total_Elevationbands = getelevationdata(100, 1000, 2600, 3500, 0.003, Temp_Sample, Precipitation_Sample)
...
@time begin
Discharge, Snow_Extend, Waterbalance, Faststorage, GWstorage, Interceptionstorage, Snowstorage, Soilstorage, Waterbalance2, Snow_Elevations, Bare_Snow = runmodel(Area, Potential_Evaporation, Prec_Elevation, Temp_Elevation,
        bare_input, forest_input, grass_input, rip_input,
        bare_storage, forest_storage, grass_storage, rip_storage, Slowstorage,
        bare_parameters, forest_parameters, grass_parameters, rip_parameters, Ks, Ratio_Riparian, Total_Elevationbands)
end
