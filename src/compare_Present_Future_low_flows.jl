...
"""
function seasonal_low_flows(Discharge, Timeseries, Months_to_analyse, days, season)
...
"""
Calculates the minimum X day moving average of daily discharge (m3/s) for all climate projections with each 100 parameter sets for the given path.
...
"""
function analyse_low_flows(path_to_projections, Months_Low_Flow_Summer,Catchment_Name,  season)
    ...
    for (i, name) in enumerate(Name_Projections_45)
     ...
     # determine by looking at monthly discharges
        for run in 1:size(Past_Discharge_45)[1]
            Seasonal_Low_Flows_Past, Timing_Seasonal_Low_Flows_Past = seasonal_low_flows(Past_Discharge_45[run,:], Timeseries_Past, Months_Low_Flow_Summer, 7, season)
            Seasonal_Low_Flows_Future, Timing_Seasonal_Low_Flows_Future = seasonal_low_flows(Future_Discharge_45[run,:], Timeseries_Future_45,Months_Low_Flow_Summer, 7, season)
...
# @time begin
# Summer_Low_Flows_past45, Summer_Low_Flows_future45, Timing_Summer_Low_Flows_Past_45, Timing_Summer_Low_Flows_Future_45 = analyse_low_flows(path_45, [5,6,7,8,9,10], "Palten", "summer")
# writedlm("/home/sarah/Master/Thesis/Results/Projektionen/Palten/PastvsFuture/LowFlows/low_flows_summer4.5.txt",hcat(Summer_Low_Flows_past45, Summer_Low_Flows_future45, Timing_Summer_Low_Flows_Past_45, Timing_Summer_Low_Flows_Future_45),',')
# end
# @time begin
# Summer_Low_Flows_past85, Summer_Low_Flows_future85, Timing_Summer_Low_Flows_Past_85, Timing_Summer_Low_Flows_Future_85 = analyse_low_flows(path_85, [5,6,7,8,9,10], "Palten", "summer")
# writedlm("/home/sarah/Master/Thesis/Results/Projektionen/Palten/PastvsFuture/LowFlows/low_flows_summer8.5.txt",hcat(Summer_Low_Flows_past85, Summer_Low_Flows_future85, Timing_Summer_Low_Flows_Past_85, Timing_Summer_Low_Flows_Future_85),',')
# end
# low_flows_summer_85 = readdlm("/home/sarah/Master/Thesis/Results/Projektionen/Pitten/PastvsFuture/LowFlows/low_flows_summer8.5.txt", ',')
...
# low_flows_summer_45 = readdlm("/home/sarah/Master/Thesis/Results/Projektionen/Pitten/PastvsFuture/LowFlows/low_flows_summer4.5.txt", ',')
...
# @time begin
# Winter_Low_Flows_past45, Winter_Low_Flows_future45, Timing_Winter_Low_Flows_Past_45, Timing_Winter_Low_Flows_Future_45 = analyse_low_flows(path_45, [11,12,1,2,3,4], "winter", "Gailtal")
# Winter_Low_Flows_past85, Winter_Low_Flows_future85, Timing_Winter_Low_Flows_Past_85, Timing_Winter_Low_Flows_Future_85 = analyse_low_flows(path_85, [11,12,1,2,3,4], "winter", "Gailtal")
# end
...
function plot_low_flows_summer(Seasonal_Low_Flows_past45, Seasonal_Low_Flows_future45, Seasonal_Low_Flows_past85, Seasonal_Low_Flows_future85, Timing_Seasonal_Low_Flows_past45, Timing_Seasonal_Low_Flows_future45,  Timing_Seasonal_Low_Flows_past85, Timing_Seasonal_Low_Flows_future85, Catchment_Name, Area_Catchment)
    ...
    for proj in 1:14
        ...
        savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/"*Catchment_Name*"_summerlowflows_"*string(Name_Projections_45[proj])*".png")
    end
    ...
    #ylims!((2,10))
    title!("Summer Low Flows 30 year average of Lowest 7 day runoff from May - Oct")
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/"*Catchment_Name*"_summerlowflows.png")
    ...
    #ylims!((2,10))
    title!("Summer Low Flows 30 year average of Lowest 7 day runoff from May - Oct")
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/"*Catchment_Name*"_summerlowflows_mm.png")
    ...
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/"*Catchment_Name*"_timing_summerlowflows.png")
    ...
    for proj in 1:14
        ...
        ylims!((213,289))
        title!("Timing of Summer Low Flows 30 year average of Lowest 7 day runoff from May - Oct")
        savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/"*Catchment_Name*"_timing_summerlowflows_"*string(Name_Projections_45[proj])*".png")
    end
    ...
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/"*Catchment_Name*"_change_summerlowflows.png")
    ...
    #PyPlot.suptitle("Change in Summer Low Flows 30 year average of Lowest 7 day runoff from May - Nov")
    plot(absolute_change, relative_change)
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/"*Catchment_Name*"_change_summerlowflows_mm.png")
    ...
    plot(absolute_change, relative_change)
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/"*Catchment_Name*"_change_summerlowflows_violins.png")
    ...
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/"*Catchment_Name*"_change_timing_magnitude_summerlowflows_violins.png")
    ...
    #PyPlot.suptitle("Change in Summer Low Flows 30 year average of Lowest 7 day runoff from May - Nov")
    plot(relative_change, absolute_change_timing)
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/"*Catchment_Name*"_change_timing_magnitude_summerlowflows.png")
end
...
function plot_low_flows_winter(Seasonal_Low_Flows_past45, Seasonal_Low_Flows_future45, Seasonal_Low_Flows_past85, Seasonal_Low_Flows_future85, Timing_Seasonal_Low_Flows_past45, Timing_Seasonal_Low_Flows_future45,  Timing_Seasonal_Low_Flows_past85, Timing_Seasonal_Low_Flows_future85, Catchment_Name, Area_Catchment)
    ...
    for proj in 1:14
            ...
            savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/"*Catchment_Name*"_Winterlowflows_"*string(Name_Projections_45[proj])*".png")
        end
        # plot seasonal low flows of all projections combined
        boxplot(Seasonal_Low_Flows_past45, color=[Farben45[1]])
        boxplot!(Seasonal_Low_Flows_future45,color=[Farben45[2]])
        ...
        #ylims!((2,10))
        title!("Winter Low Flows 30 year average of Lowest 7 day runoff from Nov - Apr")
        savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/"*Catchment_Name*"_Winterlowflows.png")
        ...
        #ylims!((2,10))
        title!("Winter Low Flows 30 year average of Lowest 7 day runoff from Nov - Apr")
        savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/"*Catchment_Name*"_Winterlowflows_mm.png")
        ...
        savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/"*Catchment_Name*"_timing_Winterlowflows.png")
        ...
        for proj in 1:14
            ...
            yticks!([1, 32, 60, 91, 305, 335], ["1.1", "1.2", "1.3", "1.4", "1.11", "1.12"])
            title!("Timing of Winter Low Flows 30 year average of Lowest 7 day runoff from Nov - Apr")
            savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/"*Catchment_Name*"_timing_Winterlowflows_"*string(Name_Projections_45[proj])*".png")
        end
        ...
        xticks!([1:2;], ["RCP 4.5", "RCP 8.5"])
        ylabel!("relative change [%]")
        #title!("Relative Change in Winter Low Flows 30 year average of Lowest 7 day runoff from May - Nov (Future - Present)")
        relative_change = boxplot!()


        #PyPlot.suptitle("Change in Winter Low Flows 30 year average of Lowest 7 day runoff from May - Nov")
        plot(absolute_change, relative_change)
        savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/"*Catchment_Name*"_change_Winterlowflows.png")
        ...
        #PyPlot.suptitle("Change in Winter Low Flows 30 year average of Lowest 7 day runoff from May - Nov")
        plot(absolute_change, relative_change)
        savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/"*Catchment_Name*"_change_Winterlowflows_mm.png")
        ...
        plot(absolute_change, relative_change)
        savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/"*Catchment_Name*"_change_Winterlowflows_violins.png")
        ...
        # #PyPlot.suptitle("Change in Winter Low Flows 30 year average of Lowest 7 day runoff from May - Nov")
        # plot(absolute_change_timing)
        # savefig("/home/sarah/Master/Thesis/Results/Projektionen/Gailtal/PastvsFuture/LowFlows/change_timing_Winterlowflows.png")
        ...
        #PyPlot.suptitle("Change in Winter Low Flows 30 year average of Lowest 7 day runoff from May - Nov")
        plot(relative_change, absolute_change_timing)
        savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/"*Catchment_Name*"_change_timing_magnitude_Winterlowflows_violins.png")
    end

Area_Zones = [115496400.]
Area_Catchment = sum(Area_Zones)
#plot_low_flows_summer(Summer_Low_Flows_past45, Summer_Low_Flows_future45, Summer_Low_Flows_past85, Summer_Low_Flows_future85,  Timing_Summer_Low_Flows_Past_45, Timing_Summer_Low_Flows_Future_45,  Timing_Summer_Low_Flows_Past_85, Timing_Summer_Low_Flows_Future_85, "Pitten", Area_Catchment)
#plot_low_flows_winter(Winter_Low_Flows_past45, Winter_Low_Flows_future45, Winter_Low_Flows_past85, Winter_Low_Flows_future85,  Timing_Winter_Low_Flows_Past_45, Timing_Winter_Low_Flows_Future_45,  Timing_Winter_Low_Flows_Past_85, Timing_Winter_Low_Flows_Future_85, "Gailtal", Area_Catchment)


# ---------------- HYDROLOGICAL DROUGHTS --------------------------
function get_threshold_hydrological_drought(Measured_Discharge, startyear, endyear, percentile)
    ...
    Discharge = convert(Matrix, Measured_Discharge)
...
function plot_drought_statistics_rel_change(Drought_45, Drought_85, Threshold, Catchment_Name, season)
    ...
    # plot change in Number of Drought days in year
    #println(filter(!isnan, relative_error(Drought_45.Nr_Drought_Days_Future, Drought_45.Nr_Drought_Days_Past)))
