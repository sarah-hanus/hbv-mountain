...
function plot_low_flows_summer(Seasonal_Low_Flows_past45, Seasonal_Low_Flows_future45, Seasonal_Low_Flows_past85, Seasonal_Low_Flows_future85, Timing_Seasonal_Low_Flows_past45, Timing_Seasonal_Low_Flows_future45,  Timing_Seasonal_Low_Flows_past85, Timing_Seasonal_Low_Flows_future85, Catchment_Name, Area_Catchment, nr_runs)
    ...
    for proj in 1:14
        ...
        savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/Summer/"*Catchment_Name*"_summerlowflows_"*string(Name_Projections_45[proj])*".png")
    end
    ...
    #ylims!((2,10))
    title!("Summer Low Flows 30 year average of Lowest 7 day runoff from May - Oct")
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/Summer/"*Catchment_Name*"_summerlowflows.png")
    ...
    #ylims!((2,10))
    title!("Summer Low Flows 30 year average of Lowest 7 day runoff from May - Oct")
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/Summer/"*Catchment_Name*"_summerlowflows_mm.png")
    ...
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/Summer/"*Catchment_Name*"_timing_summerlowflows.png")
    ...
    for proj in 1:14
        ...
        ylims!((121,289))
        title!("Timing of Summer Low Flows 30 year average of Lowest 7 day runoff from May - Oct")
        savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/Summer/"*Catchment_Name*"_timing_summerlowflows_"*string(Name_Projections_45[proj])*".png")
    end
    ...
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/Summer/"*Catchment_Name*"_change_summerlowflows.png")
    ...
    relative_change = boxplot!()
    plot(absolute_change, relative_change)
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/Summer/"*Catchment_Name*"_change_summerlowflows_mm.png")
    ...
    plot(absolute_change, relative_change)
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/Summer/"*Catchment_Name*"_change_summerlowflows_violins.png")
    ...
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/Summer/"*Catchment_Name*"_change_timing_magnitude_summerlowflows_violins.png")
    ...
    absolute_change_timing = boxplot!()
    plot(relative_change, absolute_change_timing)
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/Summer/"*Catchment_Name*"_change_timing_magnitude_summerlowflows.png")
end
...
function plot_low_flows_winter(Seasonal_Low_Flows_past45, Seasonal_Low_Flows_future45, Seasonal_Low_Flows_past85, Seasonal_Low_Flows_future85, Timing_Seasonal_Low_Flows_past45, Timing_Seasonal_Low_Flows_future45,  Timing_Seasonal_Low_Flows_past85, Timing_Seasonal_Low_Flows_future85, Catchment_Name, Area_Catchment, nr_runs)
    ...
    for proj in 1:14
        ...
        savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/Winter/"*Catchment_Name*"_winterlowflows_"*string(Name_Projections_45[proj])*".png")
    end
    # plot seasonal low flows of all projections combined
    boxplot(Seasonal_Low_Flows_past45, color=[Farben45[1]])
    boxplot!(Seasonal_Low_Flows_future45,color=[Farben45[2]])
    ...
    #ylims!((2,10))
    title!("Winter Low Flows 30 year average of Lowest 7 day runoff from Nov - Apr")
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/Winter/"*Catchment_Name*"_winterlowflows.png")
    ...
    #ylims!((2,10))
    title!("Winter Low Flows 30 year average of Lowest 7 day runoff from Nov - Apr")
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/Winter/"*Catchment_Name*"_winterlowflows_mm.png")
    ...
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/Winter/"*Catchment_Name*"_timing_winterlowflows.png")
    ...
    for proj in 1:14
        ...
        ylims!((1,335))
        title!("Timing of Winter Low Flows 30 year average of Lowest 7 day runoff from Nov - Apr")
        savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/Winter/"*Catchment_Name*"_timing_winterlowflows_"*string(Name_Projections_45[proj])*".png")
    end
    ...
    relative_change = boxplot!()
    plot(absolute_change, relative_change)
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/Winter/"*Catchment_Name*"_change_winterlowflows.png")
    #absolute and relative decrease in mm
    boxplot(convertDischarge(Seasonal_Low_Flows_future45, Area_Catchment) - convertDischarge(Seasonal_Low_Flows_past45, Area_Catchment),color=[Farben45[2]])
    #boxplot!(, color=[Farben85[1]])
    boxplot!(convertDischarge(Seasonal_Low_Flows_future85, Area_Catchment) - convertDischarge(Seasonal_Low_Flows_past85, Area_Catchment), size=(1000,500), leg=false, left_margin = [5mm 0mm], xrotation = 60, color=[Farben85[2]], bottom_margin = 20px)
    ...
    relative_change = boxplot!()
    plot(absolute_change, relative_change)
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/Winter/"*Catchment_Name*"_change_winterlowflows_mm.png")
    ...
    plot(absolute_change, relative_change)
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/Winter/"*Catchment_Name*"_change_winterlowflows_violins.png")
    ...
    absolute_change_timing = boxplot!()
    plot(relative_change, absolute_change_timing)
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/Winter/"*Catchment_Name*"_change_timing_magnitude_winterlowflows_violins.png")
    ...
    absolute_change_timing = boxplot!()
    plot(relative_change, absolute_change_timing)
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/LowFlows/Winter/"*Catchment_Name*"_change_timing_magnitude_winterlowflows.png")
end
...
function plot_drought_statistics(Drought_45, Drought_85, Threshold, Catchment_Name, Area_Catchment, season)
    ...
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/Drought/"*season*"/drought_statistics_comparison"*string(Threshold)*"_all_years_"*season*".png")
    # make violin plots
    # plot change in Number of Drought days in year
    ...
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/Drought/"*season*"/drought_statistics_comparison"*string(Threshold)*"_all_years_"*season*"_violin.png")
end
...
function plot_drought_statistics_rel_change(Drought_45, Drought_85, Threshold, Catchment_Name, Area_Catchment, season)
    ...
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/Drought/"*season*"/drought_statistics"*string(Threshold)*"_all_years_"*season*"_rel_change_4metrics.png")
    # plot(Nr_Drought_Days, Nr_Drought_Events, Max_Drought_Length, Mean_Drought_Length, Max_Deficit, Mean_Deficit, Max_Intensity, Mean_Intensity, layout= (2,4), legend = false, size=(2400,1200), left_margin = [5mm 0mm], bottom_margin = 20px)
    ...
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/Drought/"*season*"/drought_statistics"*string(Threshold)*"_all_years_"*season*"_rel_change_violin_4metrics_font.png")
    plot(Nr_Drought_Days, Nr_Drought_Events, Max_Drought_Length, Mean_Drought_Length, Max_Deficit, Mean_Deficit, Max_Intensity, Mean_Intensity, layout= (2,4), legend = false, size=(2400,1200), left_margin = [5mm 0mm], bottom_margin = 20px)
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/Drought/"*season*"/drought_statistics"*string(Threshold)*"_all_years_"*season*"_rel_change_violin.png")
end
...
function plot_drought_statistics_change(Drought_45, Drought_85, Threshold, Catchment_Name, Area_Catchment, season)
    ...
    #savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/Drought/change_mean_deficit"*string(Threshold)*"_all_years_"*season*".png")
    plot(Nr_Drought_Days, Mean_Drought_Length, Mean_Deficit, Mean_Intensity, layout= (2,2), legend = false, size=(2400,1200), left_margin = [5mm 0mm], bottom_margin = 20px)
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/Drought/"*season*"/drought_statistics"*string(Threshold)*"_all_years_"*season*"_4metrics.png")
    # plot(Nr_Drought_Days, Nr_Drought_Events, Max_Drought_Length, Mean_Drought_Length, Max_Deficit, Mean_Deficit, Max_Intensity, Mean_Intensity, layout= (2,4), legend = false, size=(2400,1200), left_margin = [5mm 0mm], bottom_margin = 20px)
    ...
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/Drought/"*season*"/drought_statistics"*string(Threshold)*"_all_years_"*season*"_violin_4metrics_font.png")
    plot(Nr_Drought_Days, Nr_Drought_Events, Max_Drought_Length, Mean_Drought_Length, Max_Deficit, Mean_Deficit, Max_Intensity, Mean_Intensity, layout= (2,4), legend = false, size=(2400,1200), left_margin = [5mm 0mm], bottom_margin = 20px)
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/Drought/"*season*"/drought_statistics"*string(Threshold)*"_all_years_"*season*"_violin.png")
end
...
function plot_drought_total_deficit(Drought_45, Drought_85, Threshold, Catchment_Name, Area_Catchment, season)
    ...
    savefig("/home/sarah/Master/Thesis/Results/Projektionen/"*Catchment_Name*"/PastvsFuture/Drought/"*season*"/drought_statistics_total_deficit"*string(Threshold)*"_all_years_"*season*".png")
end
