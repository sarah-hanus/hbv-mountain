...
# @everywhere function run_MC(ID, nmax)
        ...
        ID_Prec_Zones = [100123, 16910, 100180, 100206]
        # size of the area of precipitation zones
        Area_Zones = [1.6875598E+07,	1.2727604E+07,	5.2633064E+06,	6.4765331E+07]
        ...
        Areas_HRUs =  CSV.read(local_path*"HBVModel/Silbertal/HBV_Area_Elevation_round.csv", skipto=2, decimal='.', delim = ',')
        # get the percentage of each HRU of the precipitation zone
        Percentage_HRU = CSV.read(local_path*"HBVModel/Silbertal/HRU_Prec_Zones.csv", header=[1], decimal='.', delim = ',')
        ...
        Observed_Discharge = Observed_Discharge * 1000 / 102000000 * (3600 * 24)
        ...
        Elevations_All_Zones = [Elevations_100123, Elevations_16910, Elevations_100180, Elevations_100206]
        ...
        Total_Precipitation = Precipitation_All_Zones[4][:,1]
