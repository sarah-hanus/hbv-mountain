...
#                 AC_Function, Lags_Function = autocorrelationcurve2(Discharge, Timelag)
#                 @test AC == AC_Function
...
@testset "runoff" begin
        for i in 1 :100
                ...
                Runoff_Function, Month = monthlyrunoff(Area, Precipitation, Discharge,Timeseries)
                ...
                Runoff_mean_yearly = averagemonthlyrunoff(Runoff_Function, Month)
