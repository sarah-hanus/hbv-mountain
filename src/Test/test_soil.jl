...
@testset "soilstorage" begin
    for i in 1:100000
        ...
        Overlandflow, Percolationflow, Preferentialflow, Soil_Evaporation, Soilstorage = soilstorage(Effective_Precipitation, Interception_Evaporation, Potential_Evaporation, Storage, beta, Ce, Percolationcapacity, Ratio_Pref, Soilstoragecapacity)
        @test Overlandflow == 0
        ...
        @test Soilstorage == Storage - Soil_Evaporation - Percolationflow
        ...
        @test round(Preferentialflow, digits=12) == round(Effective_Precipitation - DischargeSoil - Overlandflow, digits=12)
        ...
        @test Soilstorage == Storage_New - Soil_Evaporation - Percolationflow
        ...
        @test round(Overlandflow + Preferentialflow, digits=12) == round(Effective_Precipitation, digits=12)
        @test Soil_Evaporation == min(Storage,(Potential_Evaporation - Interception_Evaporation) * min((Storage)/(Soilstoragecapacity * Ce),1))
        @test Percolationflow == (Storage - Soil_Evaporation)/Soilstoragecapacity * Percolationcapacity
        @test Soilstorage == Storage - Soil_Evaporation - Percolationflow
