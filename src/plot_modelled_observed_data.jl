...
function run_bestparameters_palten(path_to_best_parameter, nmax)
...
#All_Discharges, All_GWstorage, ALl_Snowstorage, All_Snow_Elevations, All_Soilstorage, All_Snow_Cover_Modeled, All_Snow_Cover_Observed, Observed_Discharge, Timeseries = run_bestparameters_palten("/home/sarah/Master/Thesis/Calibrations/Paltental/Paltental_Parameterfit_All_best_100.csv", 100)

function plot_hydrographs(All_Discharges, Timeseries)
        for i in 1:24
                current_year = 1985+i
                ...
                xlabel!("Time in Year")
                savefig("/home/sarah/Master/Thesis/Results/Calibration/Paltental/Discharge/Discharge_All_"*string(current_year)*".png")
        end
end

function plot_gwstorage(GW_Storage, Timeseries)
        for i in 1:24
                current_year = 1985+i
                indexfirstday = findall(x -> x == Dates.firstdayofyear(Date(current_year,1,1)), Timeseries)[1]
                indexlasttday = findall(x -> x == Dates.lastdayofyear(Date(current_year,1,1)), Timeseries)[1]
                ...
                xlabel!("Time in Year")
                savefig("/home/sarah/Master/Thesis/Results/Calibration/Paltental/GWStorage/GW_Storage_"*string(current_year)*".png")
        end
        ...
        ylabel!("Slow Storage [mm]")
        xlabel!("Time in Year")
        savefig("/home/sarah/Master/Thesis/Results/Calibration/Paltental/GWStorage/GW_Storage_all_years"*string(current_year)*".png")
        plot()
        for h in 1:100
                mean_GW = Float64[]
                mean_Date = Date[]
        ...
        ylabel!("Slow Storage [mm]")
        xlabel!("Time in Year")
        savefig("/home/sarah/Master/Thesis/Results/Calibration/Paltental/GWStorage/GW_Storage_mean_all_years.png")
        #plot!(Timeseries[indexfirstday:indexlasttday], Observed_Discharge[indexfirstday:indexlasttday], label="Observed",size=(1800,1000), color = ["red"])
end

function plot_snowstorage(Snowstorage, Timeseries)
        for i in 1:24
                current_year = 1985+i
                indexfirstday = findall(x -> x == Dates.firstdayofyear(Date(current_year,1,1)), Timeseries)[1]
                indexlasttday = findall(x -> x == Dates.lastdayofyear(Date(current_year,1,1)), Timeseries)[1]
                ...
                xlabel!("Time in Year")
                savefig("/home/sarah/Master/Thesis/Results/Calibration/Paltental/Snow_Storage/Snow_Storage_"*string(current_year)*".png")
        end
        ...
        ylabel!("Snow Storage [mm]")
        xlabel!("Time in Year")
        savefig("/home/sarah/Master/Thesis/Results/Calibration/Paltental/Snow_Storage/Snow_Storage_all_years"*string(current_year)*".png")
end

function plot_snowcover(All_Snow_Cover_Modeled, All_Snow_Cover_Observed, min_elevation, max_elevation)
        ...
        for i in 1:1
                ...
                current_year = 1999+i
                indexfirstday = findall(x -> x == Dates.firstdayofyear(Date(current_year,1,1)), Timeseries)[1]
                indexlasttday = findall(x -> x == Dates.lastdayofyear(Date(2005,12,31)), Timeseries)[1]
                startday_snow = 1
                endday_snow = length(Timeseries[indexfirstday:indexlasttday])
                # h is best parameter sets
                for h in 1:1
                plot()
                        for elevation in 8:10
                ...
                savefig("/home/sarah/Master/Thesis/Results/Calibration/Paltental/Snow_Cover/Snow_Cover_high_elevations_to2005.png")

        end
end

function plot_soilstorage(Soilstorage, Timeseries)
        current_year = 1986
        indexfirstday = findall(x -> x == Dates.firstdayofyear(Date(current_year,1,1)), Timeseries)[1]
        ...
        for h in 1:20
                ...
                title!("Best parameter set: Paltental")
                savefig("/home/sarah/Master/Thesis/Results/Calibration/Paltental/Soil_Storage/Soilstorage_best_"*string(h)*".png")
        end
end

#plot_snowcover(All_Snow_Cover_Modeled, All_Snow_Cover_Observed, 700, 2500)
#plot_hydrographs(All_Discharges, Timeseries)
#plot_gwstorage(All_GWstorage, Timeseries)
#plot_snowstorage(ALl_Snowstorage, Timeseries)
plot_soilstorage(All_Soilstorage, Timeseries)
