...
function combine_calibrations()
    ...
    for i in 1:7
        calibration1 = readdlm("Gailtal/Calibration_4.05/Gailtal_Parameterfit_"*string(i)*"_desktop.csv", ',')
        calibration2 = readdlm("Gailtal/Calibration_4.05/Gailtal_Parameterfit_"*string(i)*".csv", ',')
...
# all_Calibrations, total_saved = combine_calibrations()
# writedlm("Gailtal/Calibration_4.05/Gailtal_Parameterfit_All.csv", all_Calibrations, ',')

#calibration_best = calibration_statistics("Gailtal/Calibration_4.05/Gailtal_Parameterfit_All.csv", 100000)
#writedlm("Gailtal/Calibration_4.05/Gailtal_Parameterfit_best100.csv", calibration_best, ',')
