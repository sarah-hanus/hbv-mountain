...
#         Discharge_present = run_projections_gailtal(path*name*"/Gailtal/", "/home/sarah/Master/Thesis/Calibrations/Gailtal_less_dates/Gailtal_Parameterfit_All_less_dates_best_proj.csv", 1978, 2010, "past_2010")
#         Discharge_future = run_projections_gailtal(path*name*"/Gailtal/", "/home/sarah/Master/Thesis/Calibrations/Gailtal_less_dates/Gailtal_Parameterfit_All_less_dates_best_proj.csv", 2068, 2100, "future_2100")
...
for (i, name) in enumerate(Name_Projections)
        print(i)
        name = Name_Projections[i]
        Discharge_present = run_projections_feistritz(path*name*"/Pitten/", "/home/sarah/Master/Thesis/Calibrations/Feistritz_less_dates/Feistritz_Parameterfit_All_less_dates_unique_best_300.csv", 1981, 2010, "past_2010",3)
        Discharge_future = run_projections_feistritz(path*name*"/Pitten/", "/home/sarah/Master/Thesis/Calibrations/Feistritz_less_dates/Feistritz_Parameterfit_All_less_dates_unique_best_300.csv", 2071, 2100, "future_2100", 10)
end
